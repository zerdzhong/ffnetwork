...
#define FF_CAPABILITY(x) \
  FF_THREAD_ANNOTATION_ATTRIBUTE__(capability(x))

#define FF_SCOPED_CAPABILITY \
  FF_THREAD_ANNOTATION_ATTRIBUTE__(scoped_lockable)

#define FF_GUARDED_BY(x) \
  FF_THREAD_ANNOTATION_ATTRIBUTE__(guarded_by(x))

#define FF_PT_GUARDED_BY(x) \
  FF_THREAD_ANNOTATION_ATTRIBUTE__(pt_guarded_by(x))
